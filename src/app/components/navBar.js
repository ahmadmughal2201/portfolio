...
const NavBar = () => {
  ...
  return (
    <header className='w-full px-16 md:px-32 lg:px-32 py-8 bg-primary font-medium flex items-center justify-between dark:text-light sticky bg-opacity-75 top-0 z-10 dark:bg-opacity-75  dark:bg-dark'>
